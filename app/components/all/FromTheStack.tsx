          ...
          <div className="flex flex-col gap-3 sm:gap-4">
            <h2
              ...
              style={{
                ...
                fontWeight: 500,
                fontStyle: "normal",
                fontSize: "clamp(2.5rem, 6vw, 100.37px)",
                lineHeight: "134.2px",
                letterSpacing: "0%",
            ...
            <p
              className="text-sidebar/60 max-w-2xl text-xs sm:text-sm md:text-base"
              style={{
          ...
          {[...stackItems, ...stackItems].map((item, idx) => (
            ...
            >
              ...
              `}>
                ...
                {(idx === 2 || idx === 5) && (
                  <div className="absolute bottom-6 sm:bottom-8 md:bottom-12 right-6 sm:right-8 md:right-12 w-12 sm:w-16 md:w-24 h-12 sm:h-16 md:h-24 bg-[#A0E2D1]/90 rounded-full flex items-center justify-center text-sidebar font-bold text-xs sm:text-sm md:text-lg backdrop-blur-sm shadow-xl z-20">
                    Drag
                  </div>
                )}
              </div>
