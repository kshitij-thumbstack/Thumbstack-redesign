        ...
        <div className="relative w-full flex flex-col border-t border-gray-100">
          {fields.map((field) => (
            <div 
              ...
              className={`w-full group cursor-pointer transition-all duration-500 relative ${
                activeItem === field.id 
              ...
              <AnimatePresence>
                {activeItem === field.id && (
                  <motion.div 
                    ...
                    className="md:absolute right-0 top-1/2 md:-translate-y-1/2 w-full md:w-[45%] flex justify-end mt-12 md:mt-0 md:pr-12 pointer-events-none"
                  >
                    <div className="relative w-full aspect-[4/5] md:h-[600px] rounded-2xl overflow-hidden shadow-2xl z-20 pointer-events-auto border-4 border-white/10">
                      <Image 
                        src={field.image}
                        alt={field.title}
                        fill
                      ...
                      <motion.div 
                        ...
                        className="absolute top-1/2 -left-8 md:-left-16 -translate-y-1/2 w-20 h-20 md:w-32 md:h-32 bg-mint rounded-full flex justify-center items-center font-bold text-sidebar text-sm md:text-xl cursor-pointer shadow-xl hover:scale-110 transition-transform z-30"
                      >
                        View
                      </motion.div>
                    </div>
